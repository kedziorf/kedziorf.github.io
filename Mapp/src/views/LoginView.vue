                    ...
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form @submit.prevent="login" class="text-center" method="post">
                                ...
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-primary d-block w-100" style="background: #00A693;margin-bottom: 19px;">Login</button>
                                ...
                                <p class="text-muted"><a href='/register'>Don't have account yet?</a></p>
                            </form>
                        </div>
                    </div>
                </div>
