                    ...
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form class="text-center" method="post">
                                ...
                                <div class="mb-3">
                                    <button @click="handleLogin" class="btn btn-primary d-block w-100" type="submit" style="background: #00A693;margin-bottom: 19px;">Login</button>
                                    <button class="btn btn-primary d-block w-100" type="submit" style="background: var(--bs-secondary-bg);color: rgb(0,0,0);border-color: var(--bs-btn-disabled-color);">Sign in with Google
